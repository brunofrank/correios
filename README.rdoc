...
== Como Usar
  ...
  correios.calcular_frete(Correios::Servico::PAC, 0.4, 17, 16,16,16)


  # Para calcular mais de um serviço
  #Neste caso o retorno será um array.  
  correios = Correios.new(76410000, 74932180)
  correios.calcular_frete([Correios::Servico::PAC, Correios::Servico::SEDEX], 0.4, 17, 16,16,16)
...
== Outras informações
  ...
  calcular_frete(tipo, peso, comprimento, 
